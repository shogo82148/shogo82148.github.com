...
``` java Tree.java http://tes.so/6saiconf_3/img0.png
public class Tree {
    public String value;
...
``` java Tree.java http://tes.so/6saiconf_3/img1.png
public class Tree {
    public String value;
    public Tree[] children;
...
``` java Example.java http://tes.so/6saiconf_3/img2.png
...
``` java GP.java http://tes.so/6saiconf_3/img3.png
public class GP {
...
``` java Example.java http://tes.so/6saiconf_3/img4.png
public class Example {
    public static void main(String[] args) {
        GP gp = new GP(100);
...
``` java Tree.java http://tes.so/6saiconf_3/img5.png
public class Tree {
    public String value;
    public Tree[] children;
...
``` java GP.java http://tes.so/6saiconf_3/img6.png
public class GP {
    private java.util.Random rand;
    private Tree[] genes;
    private double[] values;
...
``` java Example.java http://tes.so/6saiconf_3/img7.png
public class Example {
    public static void main(String[] args) {
        GP gp = new GP(100);
        for (int i = 0; i < 50; i++)
...
``` java Example.java http://tes.so/6saiconf_3/img8.png
public class Example {
    public static void main(String[] args) {
        GP gp = new GP(100);
