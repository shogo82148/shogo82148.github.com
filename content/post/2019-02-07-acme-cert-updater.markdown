...
データを分散して保存しているので、データの整合性に制限があります。詳しくはドキュメントを参照。
...
つまり・・・・S3がその気になればデータの受け渡しは１０年２０年後ということも可能だろう・・・・・・・・・・ということ・・・・！
...
アップロード中の壊れたデータを読み出すことはありません。
壊れてほしくないデータは同じオブジェクトに連結してからアップロードすればいいのです。
